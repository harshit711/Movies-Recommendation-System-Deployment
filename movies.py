...
import pickle
import requests
from recommended_details import title, image, overview, cast, reviews, release, keywords, genres
import lzma
    ...
    <footer>
        <div style='visibility: visible;margin-top:7rem;justify-content:center;display:flex;'>
            <p style="font-size:1.1rem;">
                Made with ❤ by Harshit Kumar Taneja
                &nbsp;
                <a href="https://www.linkedin.com/in/harshit-kumar-taneja-3baa431ba/">
                ...
                &nbsp;
                <a href="https://github.com/harshit711">
